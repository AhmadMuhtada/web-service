				...
				<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
						<nav class="navbar navbar-default" role="navigation">
							<div class="container-fluid">
								...
								<div>
									...
									<li class="button">
											<li class="button"><a href="<?php echo site_url('perusahaan')?>">List Perusahaan</a></li>
											</li>
									</ul>
								</div>
					...
					<?php echo form_open_multipart('perusahaan/create'); ?>
								...
								<div class="form-group">
									...
									<input type="text" class="form-control" id="INFO_PERUSAHAAN" name="INFO_PERUSAHAAN" placeholder="Info Perusahaan" >
									<br>
									<label for="">Email Perusahaan</label>
									<input type="text" class="form-control" id="EMAIL_PERUSAHAAN" name="EMAIL_PERUSAHAAN" placeholder="Email Perusahaan" >
									<br>
									<label for="">Password</label>
									<input type="password" class="form-control" id="PASSWORD_PERUSAHAAN" name="PASSWORD_PERUSAHAAN" placeholder="Password">
									<br>
									<label for="">No. Telepon Perusahaan</label>
									<input type="text" class="form-control" id="NO_TELP_PERUSAHAAN" name="NO_TELP_PERUSAHAAN" placeholder="No Telepon Perusahaan" >
									<br>
