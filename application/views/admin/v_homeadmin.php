    ...
    <div class="container">
      ...
      <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
          <h2><font color ="black">List Admin</font></h2>
		  <hr>
		  <br>
							...
							<table class="table table-hover" id="example">
								...
								foreach ($admin as $b) { ?>
									<tr>
										...
										<td><img width="100" height="100" src="<?=base_url()?>assets/foto/admin/<?=$b->FOTO_ADMIN?>"></td>
										<td>
											
											<a href="<?php echo site_url('home_admin/update/').$b->ID_ADMIN ?>" type="button" class="btn btn-success"> <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Edit</a>
											<a href="<?php echo site_url('home_admin/delete/').$b->ID_ADMIN ?>" type="button" class="btn btn-danger" onClick="JavaScript: return confirm('Anda yakin Hapus data ini ?')"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span> Delete</a>
										</td>
									</tr>
								<?php 
								$no++;
