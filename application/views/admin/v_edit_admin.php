	...
	<div class="card card-container">
      <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
          <h1 class="page-header"><font color ="black">Edit Data Admin</font></h1>
		  <br>
			...
			<?php echo form_open_multipart('home_admin/update/'.$this->uri->segment(3)); ?>
						...
						<div class="form-group">
							...
							<input type="text" class="form-control" id="ID_ADMIN" name="ID_ADMIN" placeholder="Edit ID" value="<?php echo $admin[0]->ID_ADMIN ?>">
							<br>
							<label for="">Nama Admin</label>
							<input type="text" class="form-control" id="NAMA_ADMIN" name="NAMA_ADMIN" placeholder="Edit Nama Perusahaan" value="<?php echo $admin[0]->NAMA_ADMIN?>">
							<br>
							<label for="">Password</label>
							<input type="password" class="form-control" id="PASSWORD" name="PASSWORD" placeholder="Edit Alamat Perusahaan" value="<?php echo $admin[0]->PASSWORD?>">
							<br>
								</div>
								<div class="form-group">
