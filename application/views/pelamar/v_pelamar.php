	...
	<div class="card card-container">
      <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
          <h2 class="page-header"><font color ="black">List Pelamar</font></h2>
		  <br>
								...
								foreach ($user as $u) { ?>
									<tr>
										...
										<td>
											...
											<a href="<?php echo site_url('pelamar/update/').$u->ID_USER ?>" type="button" class="btn btn-success"> <span class="glyphicon glyphicon-pencil" aria-hidden="true"></span> Edit</a>
											<a href="<?php echo site_url('pelamar/delete/').$u->ID_USER ?>" type="button" class="btn btn-danger" onClick="JavaScript: return confirm('Anda yakin Hapus data ini ?')"><span class="glyphicon glyphicon-trash" aria-hidden="true"></span> Delete</a>
										</td>
									</tr>
								<?php
								$no++;} ?>
