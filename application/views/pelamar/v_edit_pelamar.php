	...
	<div class="card card-container">
      <div class="row">
        <div class="col-lg-8 col-lg-offset-2">
          <h1 class="page-header"><font color ="black">Edit Data Pelamar</font></h1>
			<div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
			<?php echo form_open_multipart('pelamar/update/'.$this->uri->segment(3)); ?>
			</div>	
						<!--<pre><?php 
						var_dump($pelamar); 
						?>-->
						...
						<div class="form-group">
							...
							<label for="">ID Pelamar</label>
							<input type="text" class="form-control" id="ID_USER" name="ID_USER" placeholder="ID" value="<?php echo $user[0]->ID_USER ?>">
							<br>
							<label for="">Nama Pelamar</label>
							<input type="text" class="form-control" id="NAMA_USER" name="NAMA_USER" placeholder="Nama Pelamar" value="<?php echo $user[0]->NAMA_USER ?>">
							<br>
							<label for="">Nomor Telepon</label>
							<input type="text" class="form-control" id="NO_TELP" name="NO_TELP" placeholder="No. Telp" value="<?php echo $user[0]->NO_TELP?>">
							<br>
							<label for="">Email</label>
							<input type="text" class="form-control" id="EMAIL_USER" name="EMAIL_USER" placeholder="Email" value="<?php echo $user[0]->EMAIL_USER?>">
							<br>
							<label for="">Password</label>
							<input type="password" class="form-control" id="PASSWORD_USER" name="PASSWORD_USER" placeholder="assword" value="<?php echo $user[0]->PASSWORD_USER ?>">
							<br>
							<label for="">Jenis Kelamin</label>
							<input type="text" class="form-control" id="JENIS_KELAMIN_USER" name="JENIS_KELAMIN_USER" placeholder="Jenis Kelamin" value="<?php echo $user[0]->JENIS_KELAMIN_USER?>">
							<br>
